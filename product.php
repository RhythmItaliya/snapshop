<?php
// Product Detail Page - Complete working version
...
<head>
    ...
    <title><?php echo htmlspecialchars($name); ?> - SnapShop</title>
...
<body class="min-h-screen bg-gray-50">
    ...
    <?php if ($loading): ?>
        <div class="min-h-screen bg-gray-50 flex items-center justify-center pt-20">
    ...
    <?php elseif ($error): ?>
        <div class="min-h-screen bg-gray-50 flex items-center justify-center pt-20">
            <div class="text-center">
                ...
                <a href="/snapshop/products.php" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700">
                    Back to Products
                </a>
            </div>
        </div>
